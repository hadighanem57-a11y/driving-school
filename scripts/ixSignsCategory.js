...
async function main() {
  try {
    ...
    const allCats = await Question.distinct('questionCategory');
    console.log('Before categories:', allCats);
    ...
    const afterCats = await Question.distinct('questionCategory');

    console.log('Modified:', modified);
    console.log('After categories:', afterCats);
    console.log('Law:', law);
